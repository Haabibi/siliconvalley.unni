...
window.DEEP_DIVES[287] = {
  ...
  slides: [
    ...
    { type: "action", typeLabel: "Your Action Plan", title: "This Week's Challenge", content: [
      { kind: "bullets", items: ["List everything your team has built in-house. Is each one truly core to your business?", "Identify one thing you built that could be replaced with a SaaS or OSS solution.", "Calculate: what would your team build instead if they were not maintaining that system?", "For one potential buy: do a full TCO comparison including your engineering time."] }
    ] },
    { type: "summary", typeLabel: "Key Takeaways", title: "Remember This", content: [
      { kind: "bullets", items: ["Build what differentiates your business. Buy or open-source everything else.", "The cost of building includes maintenance, hiring, security, and opportunity cost -- not just initial development.", "Default to buy/OSS and require a strong justification for building.", "Re-evaluate annually -- the market evolves and commoditizes what was once custom."] },
      { kind: "quality", items: [{ label: "Actionability", score: 5 }, { label: "Correctness", score: 5 }, { label: "Visual Appeal", score: 4 }, { label: "Engagement", score: 5 }] }
    ] }
  ]
};
...
window.DEEP_DIVES[288] = {
  ...
  slides: [
    ...
    { type: "problem", typeLabel: "The Problem", title: "When Org Structure Fights Architecture", content: [
      ...
      { kind: "bullets", items: ["Backend team and frontend team must coordinate for every feature", "Database team becomes a bottleneck for every schema change", "Platform team builds tools nobody uses because they do not understand the problems", "Architecture changes fail because the org structure resists them"] }
    ] },
    ...
    { type: "guide", typeLabel: "Step-by-Step Guide", title: "Aligning Teams with Architecture", content: [
      { kind: "bullets", items: ["Step 1: Map your current team structure and compare it to your system architecture.", "Step 2: Identify where team boundaries and system boundaries misalign.", "Step 3: Reorganize around business capabilities, not technology layers.", "Step 4: Give stream-aligned teams ownership of their full stack (UI, API, data).", "Step 5: Create a platform team to provide shared tools as self-service.", "Step 6: Measure and minimize handoffs between teams -- each handoff is a coordination cost."] }
    ] },
    ...
    { type: "action", typeLabel: "Your Action Plan", title: "This Week's Challenge", content: [
      { kind: "bullets", items: ["Draw your org chart next to your system architecture diagram. Do the boundaries match?", "Identify the top 3 cross-team handoffs that slow down feature delivery.", "Read Chapter 1 of 'Team Topologies' for the foundational concepts.", "Propose one team reorganization that would better align with your architecture."] }
    ] },
    { type: "summary", typeLabel: "Key Takeaways", title: "Remember This", content: [
      { kind: "bullets", items: ["Conway's Law: your system architecture mirrors your org structure.", "Use the inverse Conway maneuver: design teams to produce the architecture you want.", "Organize around business capabilities (stream-aligned teams), not technology layers.", "If you change the architecture without changing the org, Conway's Law will undo your work."] },
      { kind: "quality", items: [{ label: "Actionability", score: 5 }, { label: "Correctness", score: 5 }, { label: "Visual Appeal", score: 4 }, { label: "Engagement", score: 5 }] }
    ] }
  ]
};
...
window.DEEP_DIVES[289] = {
  ...
  slides: [
    ...
    { type: "problem", typeLabel: "The Problem", title: "The Open Source Business Model Challenge", content: [
      ...
      { kind: "bullets", items: ["Give away the software for free but charge for... what exactly?", "AWS wraps your open-source project as a managed service and captures the revenue", "Community contributions are sporadic and often low-quality", "License changes (like the Redis/Elasticsearch drama) alienate the community"] }
    ] },
    ...
    { type: "guide", typeLabel: "Step-by-Step Guide", title: "Building an Open Source Strategy", content: [
      { kind: "bullets", items: ["Step 1: Define your monetization model BEFORE open-sourcing.", "Step 2: Choose what to open source: developer tools and infrastructure, not core business logic.", "Step 3: Select the right license: permissive (MIT/Apache) for adoption, copyleft (AGPL) for protection.", "Step 4: Invest in community: documentation, contributor guides, responsive maintainers.", "Step 5: Build the paid tier that complements the open-source offering (hosting, enterprise, support).", "Step 6: Measure success: stars and forks are vanity metrics. Track conversions to paid."] }
    ] },
    { type: "practices", typeLabel: "Best Practices", title: "Open Source Best Practices", content: [
      { kind: "bullets", items: ["✅ Have a clear monetization strategy before open-sourcing", "✅ Invest in documentation and community as much as code", "✅ Use open source to drive adoption of your paid product", "✅ Be transparent about the relationship between open source and commercial offerings", "❌ Do not open source your core competitive advantage", "❌ Do not change licenses after building community trust (the Redis/Elasticsearch lesson)"] }
    ] },
    ...
    { type: "action", typeLabel: "Your Action Plan", title: "This Week's Challenge", content: [
      { kind: "bullets", items: ["Evaluate: does your company have any software that would benefit from being open-sourced?", "If yes: define the monetization strategy before proceeding.", "Study one successful COSS (Commercial Open Source) company's business model.", "Read about the Redis and Elasticsearch license changes to understand the risks."] }
    ] },
    { type: "summary", typeLabel: "Key Takeaways", title: "Remember This", content: [
      { kind: "bullets", items: ["Open source is a business strategy, not charity. Have a monetization plan.", "Open core and cloud/SaaS are the most successful commercial open-source models.", "Open source developer tools and infrastructure, not core business logic.", "Invest in community as much as code. Documentation and responsiveness drive adoption."] },
...
window.DEEP_DIVES[290] = {
  ...
  slides: [
    ...
    { type: "example", typeLabel: "Real-World Example", title: "How Spotify and Netflix Design Teams", content: [
      ...
      { kind: "bullets", items: ["Each team owns their services end-to-end including production on-call", "Teams choose their own tools, frameworks, and processes within guardrails", "Platform teams provide self-service infrastructure (CI/CD, monitoring, deployment)", "Teams are measured on outcomes (user impact) not output (features shipped)", "Minimal approval processes -- teams have authority to make decisions within their domain"] }
    ] },
    { type: "guide", typeLabel: "Step-by-Step Guide", title: "Redesigning Your Team Structure", content: [
      { kind: "bullets", items: ["Step 1: Map current team boundaries against system architecture. Where do they misalign?", "Step 2: Measure cognitive load per team: how many services, languages, and domains does each team own?", "Step 3: Reorganize around business streams, not technology layers.", "Step 4: Create a platform team that provides self-service tools with clear SLOs.", "Step 5: Minimize cross-team dependencies -- each team should deliver 80%+ independently.", "Step 6: Measure lead time and deploy frequency as indicators of team design health."] }
    ] },
    ...
    { type: "summary", typeLabel: "Key Takeaways", title: "Remember This", content: [
      { kind: "bullets", items: ["High-performing teams are engineered with the same rigor as software systems.", "Stream-aligned teams own a business capability end-to-end with minimal dependencies.", "Cognitive load determines team scope: 2-5 services max per team.", "Lead time from commit to production is the best measure of team design quality."] },
      { kind: "quality", items: [{ label: "Actionability", score: 5 }, { label: "Correctness", score: 5 }, { label: "Visual Appeal", score: 4 }, { label: "Engagement", score: 5 }] }
    ] }
  ]
};
...
window.DEEP_DIVES[291] = { title: "The Staff Engineer's Design Toolkit", icon: "🛠️", tag: "career", slides: [
  ...
  { type: "action", typeLabel: "Your Action Plan", title: "This Week's Challenge", content: [
    { kind: "bullets", items: ["Write an ADR for a recent technical decision.", "Identify a cross-team problem and draft a strategy document.", "Have a 1:1 with a staff engineer and ask about their day-to-day.", "Read 'Staff Engineer' by Will Larson or 'The Staff Engineer's Path' by Tanya Reilly."] }
  ] },
  { type: "summary", typeLabel: "Key Takeaways", title: "Remember This", content: [
    { kind: "bullets", items: ["Staff engineers influence technology decisions across teams without managing people.", "Technical strategy documents and ADRs are the most important output.", "Present options with trade-offs, not a single solution.", "The transition requires shifting from individual output to organizational impact."] },
    { kind: "quality", items: [{ label: "Actionability", score: 5 }, { label: "Correctness", score: 5 }, { label: "Visual Appeal", score: 4 }, { label: "Engagement", score: 5 }] }
  ] }
] };
...
window.DEEP_DIVES[292] = { title: "The Principal Engineer's Playbook", icon: "👑", tag: "career", slides: [
  ...
  { type: "practices", typeLabel: "Best Practices", title: "Principal Engineer Practices", content: [
    { kind: "bullets", items: ["✅ Think in 3-5 year horizons", "✅ Develop deep relationships with engineering leadership", "✅ Write widely-read technical strategy documents", "✅ Grow others into staff and principal roles", "❌ Do not optimize for personal contribution -- optimize for organizational capability", "❌ Do not avoid political skill -- it is required at this level"] }
  ] },
...
window.DEEP_DIVES[293] = { title: "Technical Due Diligence", icon: "🔎", tag: "career", slides: [
  ...
  { type: "summary", typeLabel: "Key Takeaways", title: "Remember This", content: [
    { kind: "bullets", items: ["Due diligence evaluates architecture, code quality, security, team, and operations.", "Technical debt directly impacts company valuation.", "Bus factor, test coverage, and deploy frequency are the most scrutinized metrics.", "Build as if you will be evaluated -- the discipline improves everything."] },
    { kind: "quality", items: [{ label: "Actionability", score: 5 }, { label: "Correctness", score: 5 }, { label: "Visual Appeal", score: 4 }, { label: "Engagement", score: 5 }] }
  ] }
] };
